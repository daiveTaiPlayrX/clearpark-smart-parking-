...
**Week 3:**
- Assisted in drafting the full **product backlog** content (user stories/items) for the Login, UI, Backend Processes, and Reporting categories, meeting the assignment's minimum item counts per category.
- Assisted in scoping a proposed **Sprint 1 backlog** focused on a demoable MVP loop.
- The student manually created the Trello board, added the drafted items as cards, and captured the screenshot themselves.

## What Was NOT Done by AI

- Final review, editing, and approval of all content was performed by the student.
- Any project-specific decisions (scope changes, prioritization, additional requirements from class discussion) will be made and documented by the student going forward.
- The GitHub repository setup, weekly commits, version updates, and the stakeholder update video are the student's own work.
